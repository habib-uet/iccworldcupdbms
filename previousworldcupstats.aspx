<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="previousworldcupstats.aspx.cs" Inherits="iccworldcupdbms.previousworldcupstats" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
 <asp:Label ID="Label2" runat="server" ></asp:Label>
    ...
    runat="server" AutoGenerateColumns="false">
    <Columns>
         <asp:BoundField DataField="bow_rank" HeaderText="BOWLING RANK" SortExpression="T20_bat_rank" ReadOnly="True" HtmlEncode="False" />
         <asp:BoundField DataField="best_figure" HeaderText="BEST FIGURES" SortExpression="best_figure" ReadOnly="True" HtmlEncode="False" />
         ...
         <asp:BoundField DataField="fiveWick" HeaderText="FIV WICKETS" SortExpression="fiveWick" ReadOnly="True" HtmlEncode="False" />
