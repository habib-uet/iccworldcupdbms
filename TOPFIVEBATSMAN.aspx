<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TOPFIVEBATSMAN.aspx.cs" Inherits="iccworldcupdbms.TOPFIVEBATSMAN" %>
...
<asp:GridView ID="GridView1" HeaderStyle-BackColor="#3AC0F2" HeaderStyle-ForeColor="White"
    ...
    runat="server" AutoGenerateColumns="false">
        <Columns>
         ...
         <asp:BoundField DataField="bat_rank" HeaderText="BATTING RAK" SortExpression="bat_rank" ReadOnly="True" HtmlEncode="False" />
